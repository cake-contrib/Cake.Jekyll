...
{
    /// <summary>
    /// Extensions for <see cref="JekyllCleanSettings"/>.
    /// </summary>
    public static class JekyllCleanSettingsExtensions
    {
        ...
        /// <returns>The <paramref name="settings"/> instance with the <see cref="JekyllCleanSettings.Future"/> property updated with the value provided in <paramref name="enable"/>.</returns>
        public static JekyllCleanSettings PublishFuture(this JekyllCleanSettings settings, bool enable = true)
        {
            if (settings is null)
            {
                throw new ArgumentNullException(nameof(settings));
        ...
        /// <returns>The <paramref name="settings"/> instance with the <see cref="JekyllCleanSettings.Watch"/> property updated with the value provided in <paramref name="enable"/>.</returns>
        public static JekyllCleanSettings EnableWatch(this JekyllCleanSettings settings, bool enable = true)
        {
            if (settings is null)
            {
                throw new ArgumentNullException(nameof(settings));
        ...
        /// <returns>The <paramref name="settings"/> instance with the <see cref="JekyllCleanSettings.Lsi"/> property updated with the value provided in <paramref name="enable"/>.</returns>
        public static JekyllCleanSettings UseLsi(this JekyllCleanSettings settings, bool enable = true)
        {
            if (settings is null)
            {
                throw new ArgumentNullException(nameof(settings));
        ...
        /// <returns>The <paramref name="settings"/> instance with the <see cref="JekyllCleanSettings.Drafts"/> property updated with the value provided in <paramref name="enable"/>.</returns>
        public static JekyllCleanSettings RenderDrafts(this JekyllCleanSettings settings, bool enable = true)
        {
            if (settings is null)
            {
                throw new ArgumentNullException(nameof(settings));
        ...
        /// <returns>The <paramref name="settings"/> instance with the <see cref="JekyllCleanSettings.IncrementalBuild"/> property updated with the value provided in <paramref name="enable"/>.</returns>
        public static JekyllCleanSettings EnableIncrementalBuild(this JekyllCleanSettings settings, bool enable = true)
        {
            if (settings is null)
            {
                throw new ArgumentNullException(nameof(settings));
        ...
        /// <returns>The <paramref name="settings"/> instance with the <see cref="JekyllCleanSettings.SafeMode"/> property updated with the value provided in <paramref name="enable"/>.</returns>
        public static JekyllCleanSettings EnableSafeMode(this JekyllCleanSettings settings, bool enable = true)
        {
            if (settings is null)
            {
                throw new ArgumentNullException(nameof(settings));
        ...
        /// <returns>The <paramref name="settings"/> instance with the <see cref="JekyllCleanSettings.LiquidProfile"/> property updated with the value provided in <paramref name="enable"/>.</returns>
        public static JekyllCleanSettings EnableLiquidProfile(this JekyllCleanSettings settings, bool enable = true)
        {
            if (settings is null)
            {
                throw new ArgumentNullException(nameof(settings));
