...
Task("restore")
    ...
    .Does(() =>
{
    DotNetRestore("./Cake.Jekyll.sln", new DotNetRestoreSettings
    {
        LockedMode = true,
    });
});
...
{
    DotNetBuild("./Cake.Jekyll.sln", new DotNetBuildSettings
    {
    ...
    .Does(() =>
{
    ...
    DotNetPack("./src/Cake.Jekyll/Cake.Jekyll.csproj", new DotNetPackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,
